...
#' @param returnresults	A logical scalar indicating if results should be returned by the funcion, default FALSE.
...
#' @import				tcltk
#' @export
#' @details				The input data must include at least these seven columns, with these names: 
