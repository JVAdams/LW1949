...
LWauto <- function(DEdata) {
	if(!estimable(DEdata)) {
		...
		LC16 <- LC(16, b0=estparams[1], b1=estparams[2])
		LC50 <- LC(50, b0=estparams[1], b1=estparams[2])
		LC84 <- LC(84, b0=estparams[1], b1=estparams[2])
		...
		# D4. Calculate S to the exponent for the LC50
		f50 <- S^(2.77/sqrt(Nprime))
		# D5. Calculate the 95% confidence limits of the LC50 as
		upper50 <- LC50 * f50
		lower50 <- LC50 / f50
