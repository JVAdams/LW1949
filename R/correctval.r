#' Predict the corrected proportion using a model fit of Table 1 of Litchfield and Wilcoxon (1949)
#'
#' Given an expected proportion, calculate the corrected proportion using a model fit of Table 1 of Litchfield and Wilcoxon (1949).
#' @param val	A numeric vector of expected values (as proportions).
