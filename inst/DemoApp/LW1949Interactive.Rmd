...
#### References
LW1949. An automated approach (R package) to Litchfield and Wilcoxon's (1949) evaluation of dose-effect experiments.  Available on [Cran](https://cran.r-project.org/web/packages/LW1949/index.html) with the latest development version on [GitHub](https://github.com/JVAdams/LW1949).
